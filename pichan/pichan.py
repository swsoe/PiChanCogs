...
class PiChan(commands.Cog):
    ...
    async def pichan(self, ctx: commands.context.Context):
        ...
        "way that the two spurving bearings were in a direct line with the panametric fan. The latter consisted simply of six " \
        "hydrocoptic marzlevanes, so fitted to the ambifacient lunar waneshaft that side fumbling was effectively prevented.  The " \
        "main winding was of the normal lotus-o-delta type placed in panendermic semi-boloid slots of the stator, every seventh " \
        ...
        "AI has now reached a high level of development, and its being successfully used in the operation of discord servers the wold over."
